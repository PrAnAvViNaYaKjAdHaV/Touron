...
import AddDomesticCityPopup from "../../../../layout/admin/domestic/city/AddDomesticCityPopup";

const AdminDomesticCity = () => {
  ...
  const handleDelete = (id) => {
    axios
      .post(`${import.meta.env.VITE_API_URL}/api/domesticcity/delete`, { id })
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_API_URL}/api/domesticcity/`)
      .then((response) => {
        setDomesticCity(response.data);
      })
      .catch((error) => {
...
export default AdminDomesticCity;
