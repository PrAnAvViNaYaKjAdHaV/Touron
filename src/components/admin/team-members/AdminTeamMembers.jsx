...
import AddTeamMembersPopup from "../../../layout/admin/team-members/AddTeamMembersPopup";
...
const AdminTeamMembers = () => {
  ...
  const handleDelete = (id) => {
    axios
      .post(`${import.meta.env.VITE_API_URL}/api/teammembers/delete`, { id })
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_API_URL}/api/teammembers/`)
      .then((res) => {
            ...
            <tbody className="text-gray-700">
              {teamMembers.map((row, index) => (
                ...
                >
                  ...
                  <td className="py-3 px-5">{row.designation}</td>
