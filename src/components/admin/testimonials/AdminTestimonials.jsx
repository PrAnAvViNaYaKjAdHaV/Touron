...
import AddTestimonialsPopup from "../../../layout/admin/testimonials/AddTestimonialsPopup";
...
const AdminTestimonials = () => {
  ...
  const handleDelete = (id) => {
    axios
      .post(`${import.meta.env.VITE_API_URL}/api/testimonials/delete`, { id })
            ...
            <tbody className="text-gray-700">
              {testimonials.map((row, index) => (
                ...
                >
                  ...
                  <td className="py-3 px-5">{row.comment}</td>
                  <td className="py-3 px-5">{row.tourPlace}</td>
                  <td className="py-3 px-5">{row.field}</td>
