...
import AddVendorPopup from "../../../layout/admin/vendor/AddVendorPopup";
...
const AdminVendor = () => {
  ...
  const handleDelete = (id) => {
    axios
      .post(`${import.meta.env.VITE_API_URL}/api/vendor/deletevendor`, { id })
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_API_URL}/api/vendor/`)
      .then((res) => {
