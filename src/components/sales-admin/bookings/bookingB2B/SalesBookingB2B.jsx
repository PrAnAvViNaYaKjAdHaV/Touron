...
const SalesBookingB2B = () => {
  ...
  const [bookingb2bData, setBookingb2bData] = useState([]);
    ...
    const fetchRequests = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_API_URL}/api/bookingb2b/mobile`,
          {
            params: {
...
export default SalesBookingB2B;
