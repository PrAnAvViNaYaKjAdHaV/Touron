...
import AddParticularPopup from "../../../layout/sales-admin/AddParticularPopup";

const SalesAdminParticular = () => {
  ...
  const handleDelete = (id) => {
    axios
      .post(`${import.meta.env.VITE_API_URL}/api/particular/deleteparticular`, {
        id,
      })
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_API_URL}/api/particular/`)
      .then((res) => {
  ...
  return (
    <div className=" py-20 px-4 sm:px-10">
      <div className=" flex flex-col sm:flex-row gap-2 justify-between sm:items-center pb-20">
        <h1 className=" text-2xl sm:text-4xl font-semibold text-stone-800">Particular</h1>
        <button
...
export default SalesAdminParticular;
